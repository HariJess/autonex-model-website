...
INSERT INTO public.vehicle_price_reference_profiles (
  ...
  ('Audi', 'A6', 'sedan', 'diesel', 'automatic', 2016, 76844374, 0.0887, 15000, 'B_moderate', 6, ARRAY['v1']::TEXT[], true),
  ('Audi', 'Q5', 'suv', 'diesel', 'automatic', 2013, 50239065, 0.1000, 15000, 'A_strong', 9, ARRAY['v1']::TEXT[], true),
  ('BMW', '320d', 'sedan', 'diesel', 'manual', 2011, 32120000, 0.1492, 15000, 'B_moderate', 4, ARRAY['v1']::TEXT[], true),
  ...
  ('Chevrolet', 'Captiva', 'suv', 'diesel', 'automatic', 2015, 37224456, 0.0416, 15000, 'B_moderate', 21, ARRAY['v1']::TEXT[], true),
  ...
  ('Ford', 'Ranger', 'pickup', 'diesel', 'manual', 2025, 173113336, 0.1053, 15000, 'B_moderate', 8, ARRAY['v1']::TEXT[], true),
  ...
  ('Great Wall', 'Wingle 5 (Neuf)', 'pickup', 'diesel', NULL, 2025, 99900000, 0.1000, 15000, 'C_anchor', 2, ARRAY['v1']::TEXT[], true),
  ...
  ('Haval', 'H6', 'suv', 'petrol', 'automatic', 2025, 127623362, 0.1667, 15000, 'B_moderate', 5, ARRAY['v1']::TEXT[], true),
  ('Haval', 'H6 GT', 'suv', NULL, NULL, 2025, 199900000, 0.1000, 15000, 'C_anchor', 1, ARRAY['v1']::TEXT[], true),
  ('Haval', 'Jolion', 'suv', 'petrol', 'automatic', 2025, 134900000, 0.1272, 15000, 'B_moderate', 4, ARRAY['v1']::TEXT[], true),
  ...
  ('Hyundai', 'Galloper', 'suv', 'diesel', 'manual', 2003, 54836000, 0.1481, 15000, 'B_moderate', 4, ARRAY['v1']::TEXT[], true),
  ...
  ('Hyundai', 'i30', 'hatchback', 'diesel', 'manual', 2015, 25039274, 0.0859, 15000, 'B_moderate', 15, ARRAY['v1']::TEXT[], true),
  ('Hyundai', 'i40', 'sedan', 'diesel', 'automatic', 2016, 38940000, 0.1000, 15000, 'C_anchor', 2, ARRAY['v1']::TEXT[], true),
  ('Hyundai', 'iX35', 'suv', 'diesel', 'manual', 2014, 27512296, 0.1000, 15000, 'B_moderate', 8, ARRAY['v1']::TEXT[], true),
  ('Hyundai', 'Maxcruz', 'suv', 'diesel', 'automatic', 2014, 63360000, 0.1000, 15000, 'C_anchor', 2, ARRAY['v1']::TEXT[], true),
  ('Hyundai', 'Santa Fe (2001-2018)', 'suv', 'diesel', 'automatic', 2014, 49794904, 0.1055, 15000, 'B_moderate', 22, ARRAY['v1']::TEXT[], true),
  ('Hyundai', 'Starex', 'van', 'diesel', 'manual', 2013, 48443648, 0.0665, 15000, 'A_strong', 10, ARRAY['v1']::TEXT[], true),
  ('Hyundai', 'Terracan', 'suv', 'diesel', 'automatic', 2007, 25443065, 0.1000, 15000, 'A_strong', 6, ARRAY['v1']::TEXT[], true),
  ('Hyundai', 'Tucson (2004-2015)', 'suv', 'diesel', 'manual', 2012, 39530936, 0.1028, 15000, 'A_strong', 12, ARRAY['v1']::TEXT[], true),
  ('Hyundai', 'Veloster', 'coupe', 'petrol', 'automatic', 2014, 33880000, 0.1000, 15000, 'C_anchor', 2, ARRAY['v1']::TEXT[], true),
  ('Isuzu', 'D-Max (Neuf)', 'pickup', 'diesel', 'automatic', 2025, 174500000, 0.1000, 15000, 'C_anchor', 2, ARRAY['v1']::TEXT[], true),
  ('Isuzu', 'D-Max (Occasion)', 'pickup', 'diesel', 'manual', 2021, 68200000, 0.1000, 15000, 'B_moderate', 4, ARRAY['v1']::TEXT[], true),
  ...
  ('Kia', 'Picanto', 'hatchback', 'petrol', 'automatic', 2014, 25656813, 0.0505, 15000, 'A_strong', 14, ARRAY['v1']::TEXT[], true),
  ('Kia', 'Rio', 'other', 'petrol', 'manual', 2010, 28500000, 0.1000, 15000, 'C_anchor', 2, ARRAY['v1']::TEXT[], true),
  ('Kia', 'Sorento', 'suv', 'diesel', 'automatic', 2018, 58044749, 0.0789, 15000, 'B_moderate', 32, ARRAY['v1']::TEXT[], true),
  ('Kia', 'Sportage', 'suv', 'diesel', 'automatic', 2019, 56023530, 0.0540, 15000, 'A_strong', 22, ARRAY['v1']::TEXT[], true),
  ...
  ('Mazda', 'BT-50 (Neuf)', 'pickup', 'diesel', 'automatic', 2025, 191500000, 0.1000, 15000, 'C_anchor', 1, ARRAY['v1']::TEXT[], true),
  ('Mazda', 'BT-50 (Occasion)', 'pickup', 'diesel', 'manual', 2024, 127396327, 0.1066, 15000, 'B_moderate', 6, ARRAY['v1']::TEXT[], true),
  ...
  ('Nissan', 'NP300 (2005-2015)', 'pickup', 'diesel', 'manual', 2013, 9567560, 0.1000, 15000, 'B_moderate', 7, ARRAY['v1']::TEXT[], true),
  ('Nissan', 'Pathfinder', 'suv', 'diesel', 'automatic', 2014, 55000000, 0.1000, 15000, 'B_moderate', 4, ARRAY['v1']::TEXT[], true),
  ('Nissan', 'Patrol (1995-2010)', 'suv', 'diesel', 'manual', 2009, 137099559, 0.1199, 15000, 'B_moderate', 5, ARRAY['v1']::TEXT[], true),
  ...
  ('Peugeot', '307', 'sedan', 'petrol', 'manual', 2007, 15496042, 0.0740, 15000, 'A_strong', 5, ARRAY['v1']::TEXT[], true),
  ...
  ('Renault', 'Duster (Neuf)', 'suv', 'petrol', 'cvt', 2025, 97500000, 0.1000, 15000, 'C_anchor', 1, ARRAY['v1']::TEXT[], true),
  ('Renault', 'Duster (Occasion)', 'suv', 'petrol', 'manual', 2022, 58729641, 0.0468, 15000, 'B_moderate', 8, ARRAY['v1']::TEXT[], true),
  ...
  ('SsangYong', 'Rexton', 'suv', 'diesel', 'manual', 2014, 36114048, 0.0505, 15000, 'A_strong', 9, ARRAY['v1']::TEXT[], true),
  ...
  ('Toyota', 'Hilux', 'pickup', 'diesel', 'manual', 2025, 174365043, 0.1085, 15000, 'B_moderate', 13, ARRAY['v1']::TEXT[], true),
  ...
  ('Toyota', 'RAV4', 'suv', 'diesel', 'manual', 2009, 33967359, 0.0510, 15000, 'B_moderate', 9, ARRAY['v1']::TEXT[], true),
