 ...
 * trivialement entre `src/lib/estimation/modelProximity.ts` (TS bundle client)
 * et `supabase/functions/compute-estimation/modelProximity.ts` (Deno Edge).
 *
 * **PARITÉ STRICTE** : ce fichier doit être identique à
 * `src/lib/estimation/modelProximity.ts`. Toute modification ici doit être
 * répercutée là-bas (et vice versa).
 */
