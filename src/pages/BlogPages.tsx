...
/**
 * Derive the WebP variants from a JPG cover path.
 * /blog-covers/x.jpg -> { mobile: "...x-mobile.webp", desktop: "...x-desktop.webp" }
 * Generated by scripts/optimize-blog-covers.mjs.
 */
function deriveCoverWebpSrcSet(jpgPath: string): { mobile: string; desktop: string } | null {
  const match = jpgPath.match(/^(.*)\.(jpg|jpeg)$/i);
  if (!match) return null;
  const base = match[1];
  return { mobile: `${base}-mobile.webp`, desktop: `${base}-desktop.webp` };
}
                  ...
                  {(() => {
                    ...
                    return (
                      <picture>
                        {webp ? (
                          <>
                            <source media="(max-width: 768px)" srcSet={webp.mobile} type="image/webp" />
                            <source srcSet={webp.desktop} type="image/webp" />
                          </>
                        ) : null}
                        <img
                          src={post.cover}
