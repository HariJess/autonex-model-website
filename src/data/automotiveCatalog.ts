...
export const AUTO_DISCOVERY_CATEGORIES: AutoDiscoveryCategory[] = [
  ...
  { id: "berline", label: "Berline", href: "/recherche?vtype=berline&drive=4x2", iconKey: "berline", description: "Confort routier et usage familial." },
  ...
  { id: "crossover", label: "Crossover", href: "/recherche?vtype=crossover&drive=4x2", iconKey: "crossover", description: "Style SUV, conduite urbaine optimisée." },
  { id: "pickup", label: "Pick-up", href: "/recherche?vtype=pick_up&drive=4x4", iconKey: "pickup", description: "Charge utile et robustesse professionnelle." },
  { id: "coupe", label: "Coupé", href: "/recherche?vtype=coupe&model=coupe", iconKey: "coupe", description: "Ligne sportive et sensations de conduite." },
  { id: "cabriolet", label: "Cabriolet", href: "/recherche?vtype=cabriolet&model=cabriolet", iconKey: "cabriolet", description: "Plaisir de conduite à ciel ouvert." },
  { id: "moto", label: "Moto", href: "/recherche?vtype=moto&model=moto", iconKey: "moto", description: "Route, trail ou sport selon usage." },
  { id: "scooter", label: "Scooter", href: "/recherche?vtype=scooter&model=scooter", iconKey: "scooter", description: "Mobilité fluide en ville." },
  { id: "quad", label: "Quad", href: "/recherche?vtype=quad&model=quad", iconKey: "quad", description: "Loisir, piste et exploitation rurale." },
  { id: "buggy", label: "Buggy", href: "/recherche?vtype=buggy&model=buggy", iconKey: "buggy", description: "Véhicule léger tout-terrain récréatif." },
  ...
  { id: "van-fourgon", label: "Van / Fourgon", href: "/recherche?vtype=van_fourgon&model=fourgon", iconKey: "van", description: "Volume de chargement optimisé." },
  { id: "minibus", label: "Minibus / Bus", href: "/recherche?vtype=minibus_bus&model=bus", iconKey: "bus", description: "Transport de passagers et navettes." },
  { id: "camion", label: "Camion", href: "/recherche?vtype=camion&model=camion", iconKey: "camion", description: "Poids lourd et transport professionnel." },
