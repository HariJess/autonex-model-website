  ...
  return (
    <div className="mt-6 rounded-2xl border border-border bg-card p-4 space-y-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <p className="font-sans font-semibold text-sm">{t("monetization.creditsVisibilityTitle", "Crédits & visibilité")}</p>
      </div>
      <p className="text-xs text-muted-foreground font-sans leading-relaxed">
        {t("monetization.creditsVisibilityDesc", "Publiez et boostez vos annonces avec des packs en Ariary. Paiement manuel vérifié par l’équipe.")}
      </p>
      <Link
        to="/publier"
